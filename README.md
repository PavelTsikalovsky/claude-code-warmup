...
# Fill in CLAUDE_CODE_OAUTH_TOKEN and CRON_SECRET in .env.local

npx vercel dev
# Then call the endpoint with auth header:
# curl -H "Authorization: Bearer <CRON_SECRET>" http://localhost:3000/api/warmup
```
